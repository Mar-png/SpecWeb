...
class Model {
    ...
    step() {
        ...
        for (let i = 0; i < Object.keys(this.entityObjs).length; i++) {
            for (let j = 0; j < Object.keys(this.entityObjs).length; j++) {
...
class View {
    ...
    render(objs) {
        // while (this.mainScene.firstChild) {
        //     this.mainScene.removeChild(this.mainScene.firstChild);
        // }
        ...
        //         curDiv.style.height = `${parseInt(curObj.w)}px`;
        //         curDiv.style.width = `${parseInt(curObj.h)}px`;
        //         curDiv.style.left = `${parseInt(curObj.x)}px`;
        //         curDiv.style.top = `${parseInt(curObj.y)}px`;
        //         curDiv.style.background = curObj.color;
        //         this.mainScene.append(curDiv);
        //     }
        // }
        ...
        // for (var key in objs) {
        //     var curObj = objs[key]
        //     if (curObj.needRendering == true) {
        //         this.context.fillStyle = curObj.color;
        //         this.context.fillRect(curObj.x, curObj.y, curObj.h, curObj.w)
        //     }
        // }
